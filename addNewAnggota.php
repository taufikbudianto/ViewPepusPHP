	...
	<div class="page-content">
		<div class="row">
				...
				<div class="sidebar content-box" style="display: block;">
					<ul class="nav">
						...
						<li class="submenu"><a href="#"> <i
							...
							<ul>
								<li><a href="addNewAnggota.php">Anggota Baru</a></li>
								<li><a href="anggotaLama.php">Update Data</a></li>
							</ul></li>
				...
				<div class="row">
					<div class="col-md-12 panel-warning">
						<div class="content-box-header panel-heading">
							<div class="panel-title ">Tambah Anggota Baru</div>
						</div>
            ...
            ?>     
								...
								<br></br> <br></br> <input type="button" class="btn btn-primary"
									value="Add" id="add"> <br></br>
								...
								<div class="row">
									<div class="col-sm-2 pull-right">
										<input type="button" class="btn btn-primary" value="Clear"> <input
