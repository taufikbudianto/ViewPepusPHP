				...
				<div class="sidebar content-box" style="display: block;">
					<ul class="nav">
						...
						<li class="submenu"><a href="#"> <i
								class="glyphicon glyphicon-list"></i> Add Anggota <span
								class="caret pull-right"></span>
						</a> <!-- Sub menu -->
							<ul>
								<li><a href="addNewAnggota.php">Anggota Baru</a></li>
								<li><a href="signup.html">Anggota Lama</a></li>
							</ul></li>
				...
				<div class="row">
					<div class="col-md-12 panel-warning">
						<div class="content-box-header panel-heading">
							<div class="panel-title ">Welcome In Perpustakaan</div>
